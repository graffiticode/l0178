...
echo "🚀 L0178 GCP Deployment Setup"
echo "=============================="
...
if [ "$DEPLOY_NOW" = "y" ]; then
    ...
    if command -v docker &> /dev/null; then
        ...
        docker build -t gcr.io/$PROJECT_ID/l0178:initial .
        docker push gcr.io/$PROJECT_ID/l0178:initial

        # Deploy to Cloud Run
        gcloud run deploy l0178 \
            --image gcr.io/$PROJECT_ID/l0178:initial \
            --platform managed \
            --region us-central1 \
            --port 50178 \
