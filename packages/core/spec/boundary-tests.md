...
Run them to check the boundary holds; discard whatever they produce. Two prompts moved here from
the advisory-warning section for the same reason — their programs would bake a value the
