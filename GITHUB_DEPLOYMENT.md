...
5. Select your repository: `graffiticode/l0178`
6. Click "Connect"
...
2. Configure:
   - **Name**: `l0178-production-deploy`
   - **Description**: Deploy L0178 to production on main branch push
...
1. Click "Create Trigger"
2. Configure:
   - **Name**: `l0178-staging-deploy`
   - **Description**: Deploy L0178 staging on branch push
   - **Event**: Push to a branch
   - **Source**:
     - Repository: Your connected repo
...
```bash
PROJECT_ID=$(gcloud config get-value project)
GITHUB_REPO="graffiticode/l0178"
...
- URL: https://l0178-[hash]-uc.a.run.app
...
- URL: https://l0178-staging-[hash]-uc.a.run.app
- Full traffic routing
- Maximum instances: 10
- Memory: 256Mi

### Preview (feature branches)
- URL: https://l0178-[branch-name]-[hash]-uc.a.run.app
...
gcloud run services update-traffic l0178 \
  --to-revisions=l0178-00005-abc=100 \
  --region=us-central1
```
...
3. Verify port configuration (50178)
